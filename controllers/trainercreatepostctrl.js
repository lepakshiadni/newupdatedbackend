...
const deleteTrainercreatePostById = async (req, resp) => {
    ...
    try {
        ...
        if (!findTrainerPost) {
            ...
            const trainercreatePost = await trainerCreatePostSchema.find({ postedById: userId.toString()}).sort({ createdAt: -1 });
...
module.exports = {
    ...
    getpostTrainercreatePostById, deleteTrainerPostComment, getTrainerPostBy, hidePost,trainerPostSearchHistory,deleteTrainercreatePostById
}